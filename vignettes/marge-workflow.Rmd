...
Lastly, documentation for functions can be accessed invoking through help utility in `R`. [Online documentation](https://marge.netlify.com) with the same content is also available under the 'Reference' tab.
